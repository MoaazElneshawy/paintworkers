package com.fatmanaseer.decoration.presentation.admin
...
class AdminActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(
            this,
            "welcome ${sharedPref.adminUsername}",
            Toast.LENGTH_SHORT
        ).show()
        ...
        val appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.navigation_owners, R.id.navigation_workers, R.id.navigation_orders
            )
        )
